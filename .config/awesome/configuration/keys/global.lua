...
-- Window Management
  ...
  awful.key({modkey}, "k", focus_next_screen, {description = "focus the next screen", group = "screen"}),
  awful.key({modkey}, "j", focus_previous_screen, {description = "focus the previous screen", group = "screen"}),
